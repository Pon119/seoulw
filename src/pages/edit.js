...
import { doc, getDocs, updateDoc, collection, query, setDoc } from 'firebase/firestore';
  ...
  return (
    <div className={editStyle.editwrap}>
      <form onSubmit={handleSubmit}>
        ...
        <label htmlFor="info1"><i></i>개인 정보 수집 및 이용에 동의합니다.</label>

        <input type="submit" className={`${editStyle.inputbtn} ${isAgreed ? editStyle.active : editStyle.inputbtn}`} value="수정 완료" disabled={!isAgreed} />
      </form>
      </div>
  )
}
