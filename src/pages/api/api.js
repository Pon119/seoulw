...
// 프로미스 요청
  let [musical, play, pop, dance, classic, gukak, circus, etc] = await Promise.allSettled([
    ...
    // instance.get('', {params: {...defaultParams, cpage: 1, shcate: 'AAAA'} }), //연극
    // instance.get('', {params: {...defaultParams, cpage: 1, shcate: 'CCCD'} }), //대중음악
    // instance.get('', {params: {...defaultParams, cpage: 1, shcate: 'BBB'} }), //무용
    // instance.get('', {params: {...defaultParams, cpage: 1, shcate: 'CCCA'} }), //서양음악
    // instance.get('', {params: {...defaultParams, cpage: 1, shcate: 'CCCC'} }), //국악
    // instance.get('', {params: {...defaultParams, cpage: 1, shcate: 'EEEB'} }), //서커스/마술
    // instance.get('', {params: {...defaultParams, cpage: 1, shcate: 'EEEA'} }), //기타
  ])
...
// console.log(play, etc, musical, gukak, pop, dance, circus, classic);

} 
// play.data, pop.data, dance.data, classic.data, circus.data, etc.data
//서치
...
async function apiDetail(mt20id, res){
  ...
  const detail = axios.get('http://www.kopis.or.kr/openApi/restful/pblprfr/PF250136', {params: {service:API_KEY} }); // 공연명
